                    ...
                    <div className="flex flex-wrap items-center justify-end gap-2">
                      ...
                      {!readOnly && service.syncable ? (
                        <form action={onSyncProvider}>
                          ...
                          <button
                            type="submit"
                            className="appearance-none rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2 text-xs font-semibold text-[var(--color-text)] transition hover:bg-[var(--color-raised)]"
                          >
                            Sync now
                          </button>
                        </form>
                      ...
                      {activeConnectionService.integration === "yelp_fusion" && (
                        <div className="mb-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-3">
                          ...
                          <button
                            ...
                            className="mt-2 w-full rounded-lg vr-btn-primary py-1.5 text-xs font-semibold disabled:cursor-not-allowed disabled:opacity-50"
                          >
