...
const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  "access.role_created": "Created a role",
  "access.role_updated": "Updated a role",
  "access.role_deleted": "Deleted a role",
  "access.role_menu_granted": "Granted a menu to a role",
  "access.role_menu_revoked": "Removed a menu from a role",
  "access.member_menu_granted": "Granted a menu to a member",
  "access.member_menu_revoked": "Removed a menu from a member",
  "access.menu_created": "Created a menu item",
  "access.menu_updated": "Updated a menu item",
  "access.menu_deleted": "Deleted a menu item",

  "billing_admin.plan_overridden": "Overrode a workspace plan",
  "billing_admin.subscription_canceled": "Canceled a workspace subscription",
  "billing_admin.access_restored": "Restored workspace access",
  "billing_admin.organization_deleted": "Deleted a workspace",
  "billing.checkout_started": "Started checkout",
  "billing.webhook_revoke_skipped": "Skipped a Billing cancel webhook",
  "billing.subscription_canceled": "Canceled a subscription",
  "organization.created": "Created a workspace",
  "organization.deleted": "Deleted a workspace",
